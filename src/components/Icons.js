...
export const CircularText = ({ className, ...rest }) => (
  <svg
    ...
    {...rest}
  >
    <path id="circle" d="M 248,248 m -150,0 a 150,150 0 1,1 300,0 a 150,150 0 1,1 -300,0" fill="transparent" stroke="none"/>
  
  <text font-family="Arial" font-size="48" fill="white">
    <textPath href="#circle" startOffset="50%" text-anchor="middle">
      Faisense AI - Computer Vision
    </textPath>
  </text>
  </svg>
);
